...
namespace WidgetMicroservice.Messaging.Consuming
{
     public class TaskAssignedReceiver : BackgroundService
     {
          ...
          {
               _logger.LogInformation($"Widget microservice received message: TaskId: {taskAssignedMessage.TaskId}, TaskName: {taskAssignedMessage.TaskName}, Users: {taskAssignedMessage.AssignedByUserId}-{taskAssignedMessage.AssignedToUserId}");
          }
